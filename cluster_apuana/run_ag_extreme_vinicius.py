"""
===================================================================
TATICA ENXAME — VINICIUS
Batch: 10 datasets SMALL/MEDIUM (os mais leves)
AutoGluon Extreme com 4 HORAS de limite por dataset
Roda SEM GPU (apenas CPU)
===================================================================
"""
import os
import sys
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("ag_extreme_vinicius.log"),
...
RESULTS_FILE = "ag_extreme_vinicius.csv"

# ========================================================
# BATCH VINICIUS — 10 datasets SMALL + MEDIUM (leves)
# ========================================================
DATASETS = [
...
def main():
    logging.info("=" * 65)
    logging.info("🐝 TATICA ENXAME — VINICIUS (Batch SMALL/MEDIUM)")
    logging.info("=" * 65)
    ...
    logging.info("\n" + "=" * 65)
    logging.info("🏁 BATCH VINICIUS FINALIZADO!")
    logging.info("=" * 65)
