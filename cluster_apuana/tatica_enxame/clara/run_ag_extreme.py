...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("ag_extreme_clara.log"),
...
RESULTS_FILE = "ag_extreme_clara.csv"

# ========================================================
# BATCH CLARA — 10 datasets MEDIUM
# ========================================================
DATASETS = [
...
def main():
    logging.info("=" * 65)
    logging.info("🐝 TATICA ENXAME — CLARA (Batch MEDIUM)")
    logging.info("=" * 65)
    ...
    logging.info("\n" + "=" * 65)
    logging.info("🏁 BATCH CLARA FINALIZADO!")
    logging.info("=" * 65)
